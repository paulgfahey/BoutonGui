function [fit_center,fit_mask,bounds] = adjMask(hfig)
    ...
    if any([cx cy] < 0) || any([cx cy] > figData.dims{cs})
        ...
        fit_window = figData.stackDataShuffledProcessed{cs}(winy, winx, figData.currentZ{cs}); 
        fit_window(fit_window < figData.backgroundThresh * figData.backgroundMeanInt{cs}) = 0;
